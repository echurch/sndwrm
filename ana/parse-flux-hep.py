...
#curl -G http://www.sns.ias.edu/~jnb/SNdata/Export/hepspectrum/hepspectrum.dat > ../macros/hep.dat
...
hname = "b8"
hout = TH1F(hname,"hep-jb",50,0.0,16.0)
fn = "../macros/hep.dat"
data = []
energy = []
dots = False
...
## fin.hep.Draw() confirms all's well.
pdb.set_trace()  
