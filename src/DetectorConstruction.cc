  ...
  */
  ...
  G4Tubs*  sTubeECN = new G4Tubs("TubeECN",                                   //name
    ...
    fLogicTubeECN = new G4LogicalVolume(sTubeECN,           //shape
           ...
           new G4PVPlacement(0,                         //no rotation
			     G4ThreeVector(0.,0.,fTubeLength/2.+fTubeThickness/2.),             //at (0,0,0)
                           fLogicTube,                //logical volume
                           "TubeECN",                    //name
                           lWorld,                      //mother  volume
                           false,                       //no boolean operation
  ...
  G4Tubs*  sGapECN = new G4Tubs("GapECN",                                   //name
    ...
    fLogicGapECN = new G4LogicalVolume(sGapECN,           //shape
           ...
           new G4PVPlacement(0,                         //no rotation
			     G4ThreeVector(0.,0.,fTubeLength/2.-fGapThickness/2.),             //at (0,0,0)
  ...
  G4Tubs*  sShieldECN = new G4Tubs("ShieldECN",                                   //name
                  0.0, fTubeRadius-fGapThickness-fShieldThickness, 0.5*fTubeLength-fGapThickness/2.-fShieldThickness/2., 0.,twopi); //dimensions
    fLogicShieldECN = new G4LogicalVolume(sShieldECN,           //shape
                             fShieldMater,              //material
                             "ShieldECN");                 //name
                               
           new G4PVPlacement(0,                         //no rotation
			     G4ThreeVector(0.,0.,fTubeLength/2.-fGapThickness/2.-fShieldThickness/2.),             //at (0,0,0)
